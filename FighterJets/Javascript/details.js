const planes = {
            "Saab_Gripen": {
                ...
                history: "Developed in the 1980s to replace the Saab 35 Draken and Saab 37 Viggen fleets, the Gripen program aimed for a fighter capable of operating from short and improvised runways, including highway sections—an essential requirement in Swedish defense strategy. The first flight took place in 1988, and service entry began in 1997 with the Swedish Air Force.",
            ...
            "F-22_Raptor": {
                ...
                image_url: "Blueprints/F22bp.jpg",
                tech_specs: [
                    "Length: 18.9 m",
                    "Wingspan: 13.6 m",
            ...
            "Eurofighter_Typhoon": {
                ...
                image_url: "Blueprints/Eurofighter_bp.jpg",
                tech_specs: [
                    "Length: 15.9 m",
                    "Wingspan: 11.0 m",
            ...
            "Sukhoi_Su-57": {
                ...
                image_url: "Blueprints/Su-57bp.png",
                tech_specs: [
                    "Length: 20.1 m",
                    "Wingspan: 14.1 m",
            ...
            "B2" : {
                name: "B2 Spirit" ,
                country: "United States" ,
                description: "The B-2 Spirit is a heavy strategic bomber. It uses stealth technology to penetrate anti-aircraft defenses. It can deliver both conventional and nuclear munitions.",
                history: "It was designed during the Cold War. The first flight occurred in July 1989. It entered service in 1997. It has been used in combat operations, including in Kosovo and Iraq.",
                image_url: "Blueprints/",
                tech_specs: [
                    "Length: 20.9 m",
                    "Wingspan: 52.12 m",
                    "Maximum speed: High subsonic (approx. 1,010 km/h)",
                    "Ceiling: 15,240 m", "Range: Approximately 9,600 km without refueling.",
                    "Engine: Four General Electric F118-GE-100 turbofans, each providing 77 kN of thrust."
                ],
                armament:{
                    intro: "The B-2 can carry a payload of up to 18,144 kg",
                    list: [
                        "It can deliver precision-guided JDAM bombs.",
                         "It can deliver nuclear bombs, such as the B83.",
                          "It can carry up to eighty 230 kg bombs (Mk 82 JDAM)."
                    ]
                },
                avionics:{
                    intro: "The B-2 bomber's stealth characteristics make it difficult to detect",
                    list: [
                        "Low-Observability Technology: This technology minimizes radar, infrared, acoustic, and visual signatures.",
                        "Design: The B-2 has a flying-wing design.",
                        "Flight Control System: It uses a digital fly-by-wire system to manage flight",
                    ],
                },
            }
        };
